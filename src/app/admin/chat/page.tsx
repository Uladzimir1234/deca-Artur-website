          ...
          <div className="flex items-center gap-1">
            ...
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827m0 0v.75m0-3.6V16.5m9-5.25a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              </svg>
            </button>
            <a
                ...
                >
                  {msg.image && (
                    <img
                      src={msg.image}
                      alt="Screenshot"
                      className="rounded-xl mb-3 max-h-52 w-auto border border-white/10"
                    />
                  )}
        ...
        <div className="max-w-3xl mx-auto px-4 py-3">
          ...
          {attachment && (
            <div className="mb-3 flex items-center gap-3 bg-[#1a1d27] rounded-xl p-2.5 border border-white/[0.06]">
              ...
              <button
                ...
                className="w-7 h-7 rounded-lg hover:bg-white/[0.06] flex items-center justify-center text-gray-500 hover:text-red-400 transition-all"
              >
          ...
          <div className="flex items-end gap-2">
            ...
            <button
              ...
              className="w-10 h-10 rounded-xl hover:bg-white/[0.06] flex items-center justify-center text-gray-500 hover:text-gray-300 transition-all shrink-0"
            ...
            <div className="flex-1 relative">
              <textarea
                ...
                placeholder={`Describe changes for ${pageName}...`}
                rows={1}
                className="w-full bg-[#1a1d27] border border-white/[0.08] rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 resize-none focus:ring-1 focus:ring-[#3854AA]/50 focus:border-[#3854AA]/30 outline-none transition-all"
            ...
            <button
              ...
              className="w-10 h-10 bg-[#3854AA] hover:bg-[#4a67c0] text-white rounded-xl flex items-center justify-center transition-all disabled:opacity-30 disabled:hover:bg-[#3854AA] shrink-0 shadow-lg shadow-[#3854AA]/20"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
