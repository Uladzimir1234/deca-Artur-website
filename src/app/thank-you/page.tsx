      ...
      <main className="flex-1 px-4 -mt-20 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-4 mb-8">
            ...
            {/* Call CTA card */}
            <div className="md:col-span-2 bg-white rounded-xl border border-border shadow-sm p-5 flex flex-col justify-between">
              <div>
                <div className="w-10 h-10 rounded-full bg-[#e8873a]/10 flex items-center justify-center mb-3">
                  <svg className="w-5 h-5 text-[#e8873a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                  </svg>
                </div>
                <h3 className="font-bold text-sm text-text-primary mb-1">Need It Faster?</h3>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#e8873a] text-white font-bold px-4 py-2.5 rounded-lg hover:bg-[#d4792f] transition-colors text-sm w-full"
              >
                (413) 771-4457
              </a>
            </div>
