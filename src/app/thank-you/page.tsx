      ...
      <main className="flex-1 px-4 -mt-20 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-4 mb-8">
            ...
            {/* Call CTA card */}
            <div className="md:col-span-2 bg-[#e8873a] rounded-xl p-6 flex flex-col items-center justify-center text-white text-center">
              <div className="w-14 h-14 rounded-full bg-white/20 flex items-center justify-center mb-4">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                </svg>
              </div>
              <h3 className="font-bold text-xl mb-1">Need It Faster?</h3>
              <p className="text-white/60 text-sm leading-relaxed mb-5">
                Call us directly<br />Mon-Fri, 8 AM – 6 PM ET
              </p>
              <a
                href="tel:+14137714457"
                className="inline-flex items-center justify-center gap-2 bg-white text-[#e8873a] font-bold px-5 py-3 rounded-lg hover:bg-white/90 transition-colors text-base w-full"
              >
                (413) 771-4457
              </a>
            </div>
