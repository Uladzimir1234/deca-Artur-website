      ...
      <main className="flex-1 px-4 -mt-20 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-4 mb-8">
            ...
            {/* Call CTA card */}
            <div className="md:col-span-2 bg-[#e8873a] rounded-xl p-5 flex flex-col justify-between text-white">
              <div>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-white text-[#e8873a] font-bold px-4 py-2.5 rounded-lg hover:bg-white/90 transition-colors text-sm w-full"
              >
                (413) 771-4457
              </a>
            </div>
