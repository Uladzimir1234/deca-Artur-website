      ...
      <main className="flex-1 px-4 -mt-20 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-4 mb-8">
            ...
            {/* Call CTA card */}
            <div className="md:col-span-2 bg-brand-dark rounded-xl p-5 flex flex-col justify-between text-white">
              <div>
                <div className="w-10 h-10 rounded-full bg-[#e8873a]/20 flex items-center justify-center mb-3">
